...
<table>
    ...
    @foreach($hashtaglist as $hl)
        <tr>
            <td>{{$hl->Hashtag}}</td>
            <td>
                <a href="{{route('updateHashtagViewRoute',$hl->id)}}"><button type="button">بروزرسانی</button></a>
                <a href="{{route('deleteHashtagViewRoute',$hl->id)}}"><button type="button">حذف</button></a>
            </td>
        </tr>
    @endforeach
</table>
...
<div style="display: grid;justify-items: center">
    <a href="{{route('addHashtagRoute')}}"><button type="button">اضافه کردن هشتگ جدید</button></a>
</div>
<br>
<br>
<br>
