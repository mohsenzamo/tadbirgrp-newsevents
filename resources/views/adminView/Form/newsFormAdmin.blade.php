...
<h3 style="text-align: center">فرم اخبار</h3>
<p style="text-align: center;color: #fe720c">------------------------------------------------------------------</p>
<form class="form row" action="{{route('addNewsRoute')}}" method="post" enctype="multipart/form-data"
      style="width: 80%;justify-self: center">
    @csrf
    <div class="col-lg-6">
        <label class="field field_v3">
            <input type="text" class="field__input" placeholder="عنوان" name="title">
    ...
    <div style="display: grid">
        ...
        <br>
        <textarea name="text" id="editor" cols="30" rows="10" class="txtArea" style="float: left"></textarea>
    </div>
    <div class="col-lg-6">
        <br><br>
        <label class="field field_v3">
    ...
    <div class="col-lg-6">
        <br><br>
        <label class="field field_v3">
            <input type="text" class="field__input" placeholder="ساعت" name="time">
            <span class="field__label-wrap">
    ...
    <div class="col-lg-6">
        <br><br>
        <label class="field field_v3">
            <input type="text" class="field__input" placeholder="تاریخ" name="date">
            <span class="field__label-wrap">
        ...
        <div style="display:flex;align-items: center">
            @foreach($hashtaglist as $item2)
                <input style="margin-right: 10px;margin-left: 10px" type="radio" name="hashtag"
                       value="{{$item2->Hashtag}}">
                <label style="border-left:1px solid black;padding-left: 10px ">{{$item2->Hashtag}}</label>
            @endforeach
        </div>
        <br>
        <br>
    ...
    <div style="display: grid;justify-items: center">
        <button type="submit" class="button" style="width: 70%;background-color: #103b7f;">
            <span style="color: #fff">اضافه کردن خبر</span>
        </button>
    </div>
</form>
<br>
