...
<form class="form row" action="{{route('hashtagUpdateRoute')}}" method="post" enctype="multipart/form-data"
      style="text-align: center;margin-top: 150px;width: 100%">
    @csrf
    <input name="id" value="{{$hashtagData[0]->id}}" style="display: none">
    <div class="col-lg-12">
        <label class="field field_v3">
            <input type="text" class="field__input" placeholder="هشتگ" name="hashtag" style="width: 500px"
                   value="{{$hashtagData[0]->Hashtag}}">
    ...
    <div class="col-lg-12">
        <button type="submit" class="button btn-info">
            <span style="color: #fff"> بروزرسانی هشتگ</span>
        </button>
    </div>
